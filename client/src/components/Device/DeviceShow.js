  ...
  render() {
    return (
      <tr>
        ...
        {!this.props.dashboard && (<td>{this.props.obj.type}</td>)}
        <td>{this.props.obj.location}</td>
        {!this.props.dashboard && (<td>{this.props.obj.localIp}</td>)}
        ...
        {!this.props.dashboard && (<td>{this.props.obj.lastStatusUpdate}</td>)}
        {!this.props.dashboard && (<td>{this.props.obj.lastStateChange}</td>)}
